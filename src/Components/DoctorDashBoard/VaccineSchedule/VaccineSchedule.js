...
import { faEdit, faRightLong } from "@fortawesome/free-solid-svg-icons";
...
const [getData,setData]=React.useState([]);
    React.useEffect(()=>{
        fetch(`${BASEURL}/getScheduledVaccine`, {
          method: "POST",
          headers: {
    ...
    return(
        <div>
            <VaccineScheduleUpcomming getData={getData}/>
        </div>
    )
}
const VaccineScheduleUpcomming=({getData})=>{
...
const handleScheduledAppointment=(id)=>{
    fetch(`${BASEURL}/VaccineDone`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
return(
    <div>
         <div className="TodayAppHeading AnimationTableTop">Up comming Vaccine Scheduled</div>
...
<StyledTableRow >
        ...
        <StyledTableCell><FontAwesomeIcon onClick={()=>{handleScheduledAppointment(row._id)}} icon={faRightLong}/></StyledTableCell>
